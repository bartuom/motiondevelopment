...
- **Particlr runtime** — MIT License, copyright 2026 particlr contributors.
  ...
  - P3.14 deploys the same text fixture as `site/reference-data/particlr-explosion.prt` and renders it through `@particlr/runtime@0.8.0` + PixiJS 8.19.0 for source-fidelity calibration.
